...
static unsigned int exynos_cpufreq_fast_switch(struct cpufreq_policy *policy, unsigned int target_freq, unsigned int relation)
{
    int ret = __exynos_cpufreq_target(policy, target_freq, relation, true);
...
static struct cpufreq_driver exynos_driver = {
	...
	.fast_switch    = (unsigned int (*)(struct cpufreq_policy *, unsigned int))exynos_cpufreq_fast_switch,
